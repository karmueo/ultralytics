...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='DeepStream YOLOv8 conversion')
    parser.add_argument('-w', '--weights', required=True,
                        help='Input weights (.pt) file path (required)')
    parser.add_argument('-s', '--size', nargs='+', type=int,
                        default=[640], help='Inference size [H,W] (default [640])')
...
# python3 export_onnx.py -w "runs/detect/yolov11m_110_ir_drone+bird_6.3/weights/best.pt" --simplify --dynamic
